...
(() => {
  ...
  function VoiceInspector() {
    ...
    const downloadJson = (0, import_react.useCallback)(() => {
      const dataStr = "data:text/json;charset=utf-8," + encodeURIComponent(JSON.stringify(voices, null, 2));
    ...
    if (loading) {
      return /* @__PURE__ */ import_react.default.createElement("div", { className: "intro-msg" }, "Loading voices...");
    }
    if (voices.length === 0) {
